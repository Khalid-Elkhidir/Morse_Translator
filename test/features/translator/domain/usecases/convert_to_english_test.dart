...
import 'convert_to_english_test.mocks.dart';
...
void main() {
  ...
  ConvertToEnglish usecase = ConvertToEnglish(mockScriptRepository);

  setUp(() {
    mockScriptRepository = MockScriptRepository();
    usecase = ConvertToEnglish(mockScriptRepository);
  });
  ...
  test(
    "get english converted script for the inserted script from the repository",
        () async {
      when(mockScriptRepository.convertToEnglish(tInsertedScript))
      ...
      verify(mockScriptRepository.convertToEnglish(tInsertedScript));
